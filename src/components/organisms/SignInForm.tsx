...
export default function SignInForm() {
  ...
  return (
    <Card className="max-w-md w-full shadow-lg rounded-2xl border border-gray-200 font-[family-name:var(--font-geist-sans)] bg-white">
      <CardHeader>
        <CardTitle className="text-2xl md:text-3xl font-bold mb-1">
          Sign In
        </CardTitle>
        <CardDescription className="text-base md:text-lg text-gray-500 mb-4">
        ...
        <div className="grid gap-5">
          <div className="grid gap-2">
            ...
            <Input
              ...
              required
              className="rounded-lg border-2 border-gray-300 focus:border-black focus:ring-2 focus:ring-black/20 px-4 py-2 text-base bg-white"
              onChange={(e) => {
          ...
          <div className="grid gap-2">
            <div className="flex items-center">
              ...
              <Link
                href="#"
                className="ml-auto inline-block text-sm underline text-gray-500 hover:text-black transition-colors"
              >
          ...
          <Button
            type="submit"
            className="w-full cursor-pointer bg-black text-white rounded-lg py-2 text-base font-semibold hover:bg-gray-900 transition-colors disabled:opacity-60"
            disabled={loading}
            onClick={async () => {
              await signIn.email(
                {
          ...
          >
            {!loading ? (
              <Loader2
                size={18}
                className="animate-spin bg-transparent mx-auto cursor-wait"
              />
            ) : (
              <span className="bg-transparent text-white">Login</span>
            )}
          </Button>
          <div
            className={cn(
